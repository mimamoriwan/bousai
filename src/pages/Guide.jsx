                            ...
                            <div style={{ display: 'flex', alignItems: 'flex-start', gap: '10px', padding: '10px', backgroundColor: '#FFF7ED', borderRadius: '10px' }}>
                                ...
                                <div>
                                    ...
                                    <div style={{ fontSize: '0.85rem', color: '#78350F', lineHeight: '1.55' }}>
                                        「まずはどんなアプリか触ってみたい」というお声にお応えして、Googleログインなしですぐに投稿・マイマップ・お散歩記録などの基本機能を使い始められるようになりました！いつものお散歩で、地域の安全マップをぜひ体験してみてください。（詳しいプロフィール・MYルート・機種変更時の引き継ぎは、後からいつでも無料でGoogle連携すると追加できます）
                                    </div>
                                </div>
                            </div>
